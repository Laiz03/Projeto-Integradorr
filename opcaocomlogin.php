...
<body>
    ...
    <!-- Inicio opção DOACAO/ADOCAO -->
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Adote Pets</h6>
                <h1 class="display-6 text-uppercase mb-0">Adotar É Um Ato De Amor</h1>
            </div>
           
            <a href="doacaocomlogin.php"><button class="btn btn-primary w-100 py-4" type="submit">Quero Divulgar</button></a>
            <a href="adocaocomlogin.php"><button class="btn btn-primary w-100 py-4" type="submit">Quero Adotar</button></a>

    <!-- Final opção DOACAO/ADOCAO -->
