    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">Pets Disponíveis</h6>
                <h1 class="display-6 text-uppercase mb-0">ADOTAR É UM ATO DE AMOR</h1>
            </div>
            <div class="owl-carousel product-carousel">
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/pet1.png" alt="">
                        <div class="col-12">
                            <textarea class="form-control bg-light border-0 px-4" placeholder="Descrição do Pet" rows="3"></textarea> 
                        </div>
                        <h6 class="text-uppercase">Cachorro</h6>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href=""> <span class="heart-icon">❤ Quero Adotar</span> </a>
                        </div>
                    </div>
                </div>
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/pet2.png" alt="">
                        <div class="col-12">
                            <textarea class="form-control bg-light border-0 px-4" placeholder="Descrição do Pet" rows="3"></textarea> 
                        </div>
                        <h6 class="text-uppercase">Cachorro</h6>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/pet3.png" alt="">
                        <div class="col-12">
                            <textarea class="form-control bg-light border-0 px-4" placeholder="Descrição do Pet" rows="3"></textarea> 
                        </div>
                        <h6 class="text-uppercase">Hamster</h6>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href=""> <span class="heart-icon">❤ Quero Adotar</span> </a>
                        </div>
                    </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/pet4.png" alt="">
                        <div class="col-12">
                            <textarea class="form-control bg-light border-0 px-4" placeholder="Descrição do Pet" rows="3"></textarea> 
                        </div>
                        <h6 class="text-uppercase">Cachorro</h6>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        <img class="img-fluid mb-4" src="img/pet5.png" alt="">
                        <div class="col-12">
                            <textarea class="form-control bg-light border-0 px-4" placeholder="Descrição do Pet" rows="3"></textarea> 
                        </div>
                        <h6 class="text-uppercase">Gato</h6>
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href=""> <span class="heart-icon">❤ Quero Adotar</span> </a>
                        </div>
                    </div>
