     ...
     <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="productphp" class="nav-item nav-link">Produtos</a>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-5 text-uppercase mb-0">Seus Produtos</h1>
            </div>
            <div class="owl-carousel product-carousel">
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        ...
                        <div class="btn-action d-flex justify-content-center">
                            <a class="btn btn-primary py-2 px-3" href="compras.html"><i class="bi bi-cart">COMPRAR</i></a>
                        </div>
                    </div>
                </div>
                <div class="pb-5">
                ...
                <a href="compras.php"><button class="btn btn-primary w-100 py-4" type="submit">Finalizar Compras</button></a>
            </div>
        </div>
    </div>
    <!--  Fim Produtos -->
