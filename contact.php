...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        if ($senha === $confirmarSenha) {
            // TODO: Conectar ao banco de dados e inserir os dados na tabela "cadastro"
            ...
            $sql = "INSERT INTO cadastro (cpf, nome, sobrenome, telefone, email, senha)
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-12">
                            <input type="text" name="cpf" class="form-control bg-light border-0 px-4" placeholder="CPF" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="text" name="nome" class="form-control bg-light border-0 px-4" placeholder="Nome" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="text"name="sobrenome"  class="form-control bg-light border-0 px-4" placeholder="Sobrenome" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="tel" name="telefone" class="form-control bg-light border-0 px-4" placeholder="Telefone: (xx) xxxxx-xxxx" style="height: 55px;">
                            </div>
                            <div>
                                <input type="email" name="email" class="form-control bg-light border-0 px-4" placeholder="pet@gmail.com" style="height: 55px;">
                            </div>
                            <div>
                                <input type="password" name="senha" class="form-control bg-light border-0 px-4" placeholder="Senha" style="height: 55px;">
                            </div>
                            <div>
                                <input type="password" name="confirmarsenha" class="form-control bg-light border-0 px-4" placeholder="Confirmar Senha" style="height: 55px;">
                            </div>
