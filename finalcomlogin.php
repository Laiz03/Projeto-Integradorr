...
<body>
    ...
    <div class="alert alert-success" role="alert">
        <h4 class="alert-heading" style="text-align: center;">Parabéns, Seu Pedido Foi Efetuado!</h4>
        <h5>Deseja continuar comprando?</h5>
        <a href="productcomlogin.php"><button type="submit" class="btn btn-outline-primary">Sim</button></a>
        <a href="index.php"><button type="submit" class="btn btn-outline-primary">Não</button></a>
        <hr>
        <a href="acompanhamento.php"><button type="submit" class="btn btn-outline-primary">Acompanhar Pedido</button></a>
      </div>
