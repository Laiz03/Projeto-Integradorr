...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <a href="doacao.php"><button class="btn btn-primary w-100 py-4" type="submit">Quero Divulgar</button></a>
            <a href="adocao.php"><button class="btn btn-primary w-100 py-4" type="submit">Quero Adotar</button></a>
